...
tests/                       # vitest（~2,900 tests / 186 suites，gitignored；3035 pass / 13 pre-existing）
...
| Testing | vitest（~2,900 tests / 186 suites，gitignored；3035 pass / 13 pre-existing；4 attack suites: q-rl-attack, changelog-features-attack, creative-attacks, q-rl-creative-attacks）|
