...
**Version**: 2.0.858 · **Tests**: 609 core + 45 close-related attack + 16 v2.0.858 attack (vitest, gitignored) · **Build**: `tsc --noEmit` (zero errors) + `cd ui && npx vite build` (zero errors) · **Run**: `npm run dev` (concurrently runs API :3456 + UI :5173) · **Codebase**: ~63,000 lines TypeScript + legacy React UI (now superseded by `mats_app`)
