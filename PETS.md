# MATS → 算姬戰域 / Nymph Battlefield：機械妹框架

> **核心信念**：有用嘅部分（信號）令人計數；無用嘅部分（機械妹嘅成長與記憶）令人唔捨得走。
> 每個用戶創造一個獨一無二嘅機械妹，佢嘅大腦運行 HACP，佢嘅成長就係你嘅財富。
>
> **命名**：中文「算姬戰域」= [角色] 算姬 + [世界] 戰域
> 英文「Nymph Battlefield」= Nymph（永恆少女，容顏不變）+ Battlefield（戰域）
...
- **起始狀態：幼女**——創造時嘅機械妹係幼女形態，纖細純真，保守裝束。呢個係你第一次見到佢嘅樣。
- **容顏永不改變**——你創造嗰張臉、嗰對眼、嗰個表情，由幼女到熟女永遠不變。呢個係 endowment effect 嘅基礎。
- **風韻逐階漸生**——進化時身材逐漸豐滿性感、裝束逐漸風騷大膽，但容顏始終係你創造嗰張年少樣貌。佢成長，但永遠認得係你嘅佢。
...
每個市場（BTC、ETH、SILVER…）都係一支 **魔王軍**，駐守喺嗰個市場嘅「陣地」。
機械妹嘅能量核入面住住一群 **算力兵**——佢嘅軍隊，即係你嘅資金。

每次交易 = 派算力兵去攻打某支魔王軍：

| 交易結果 | 戰場結果 | 視覺 |
|---------|---------|------|
| 盈利 | **俘虜敵兵**：打贏魔王軍，俘虜嘅敵兵轉化為算力兵，加入我軍 | 算力兵湧入能量核，能量核變亮 |
| 虧損 | **陣亡**：打輸咗，部分算力兵陣亡，軍隊縮減 | 算力兵倒下，能量核變暗 |
| 止損 | **撤退**：鳴金收兵，後撤時陣亡部分兵力 | 撤退動畫，能量核閃一下 |
| 止盈 | **攻陷敵陣**：全勝，俘虜大批敵兵 | 大量算力兵湧入，能量核爆發 |
| 爆倉 | **全軍覆沒**：派出去嘅算力兵全部陣亡 | 能量核劇烈閃爍後暗淡 |

##### 能量核狀態

| 狀態 | 視覺 | 含義 |
|------|------|------|
| 兵力充足 | 明亮脈動 | 算力兵多，可以大舉進攻 |
| 中等 | 穩定微光 | 正常兵力 |
| 兵力不足 | 暗淡閃爍 | 算力兵少，只能保守 |
| 接近耗盡 | 微弱、不穩 | 危險，需要保護佢 |

- 低兵力時，機械妹自動保守操作（細倉位、緊 SL）

**「我唔想見到佢嘅算力兵白白陣亡」** = 唔想虧損，但情感化為保護機械妹軍隊嘅衝動。

#### 3.2 記憶碎片（Memory Fragments）= 戰役卡
...
| 欄位 | 內容 | 對應 |
|------|------|------|
| 戰場 | 市場 + 方向（攻打 BTC 魔王軍） | symbol + side |
| **出兵時間** | 開倉時間 | entryTime |
| **出兵理由** | 點解要打呢場仗（機械妹嘅判斷） | entryThesis |
| **撤退時間** | 平倉時間 | exitTime |
| **撤退理由** | 點解撤退（止盈/止損/論文失效） | exitThesis |
| **俘虜/陣亡** | 盈利/虧損數額 + 算力兵變化 | pnl |
| **戰役結果** | 大勝/小勝/小敗/大敗/惜敗 | outcome |

##### 戰役卡稀有度

| 戰役結果 | 卡片稀有度 | 視覺 | 永久性 |
|---------|-----------|------|--------|
| 大勝（俘虜大批敵兵） | 金卡 | 明亮、結晶、金色邊框 | 永久 |
| 小勝（俘虜少量敵兵） | 白卡 | 柔光、白色 | 永久 |
| 小敗（少量陣亡） | 灰卡 | 灰色、微裂 | 永久 |
| 大敗（大批陣亡） | 創傷卡 | 暗黑、碎裂、紅紋 | 永久 |
| 惜敗（near-miss） | 遺憾卡 | 閃爍、不完整 | 永久 |

##### 戰役卡敘事

每張卡唔係冷冰冰嘅數據，係一段 **戰役敘事**：
...
- 戰役卡係 **永久嘅**——佢嘅經歷無法抹去
- 戰役卡影響未來決策（透過 thesis-experience 系統）
- 創傷卡令佢獨特——「我嘅機械妹經歷過 3 次閃崩，佢嘅海馬迴有 3 張創傷卡」
- 戰役越多 = 佢越有智慧（影響 HACP 中海馬迴嘅權重）

**呢個直接對應 MATS 已有嘅 `thesis-experience.ts`——只需要將 thesis record 重新 framing 為戰役卡。**

#### 3.3 進化等級（Evolution Level）= 俘虜進化
...
機械妹透過不斷攻打魔王軍、俘虜敵兵、將佢哋轉化為算力兵而成長。每累計俘虜一定數量嘅敵兵，機械妹就會 **進化**——身段更豐滿，裝束更風騷，但容顏永遠係你創造嗰張年少樣貌。

##### 視覺進化原則

機械妹嘅進化遵循一個核心設計原則：**容顏不變，風韻漸生。**

- **容顏不變**：全階段保持青靚白淨嘅年少樣貌——你創造嗰張臉永遠係佢嘅臉。呢個係 endowment effect 嘅基礎。
- **身材漸變**：由幼女嘅纖細，逐漸發育成豐滿性感嘅身段——進化嘅可見獎勵。
- **衣着漸變**：由保守純真嘅裝束，逐漸變得風騷性感——視覺驅動力。

##### 四階進化

| 階段 | 稱號 | 條件（累計俘虜） | 身材 | 裝束 | 情感定位 |
|:----:|------|:-----------:|------|------|---------|
| 一 | **幼女** | $0（創造時） | 纖細純真，平板嬌小 | 保守連身裙/制服，純真可愛 | 想保護佢 |
| 二 | **少女** | $10,000 | 開始發育，曲線初現 | 修身衣物，微微展露，青春活力 | 想養成佢 |
| 三 | **御姐輕熟女** | $100,000 | 豐滿成熟，凹凸有致 | 性感但不露骨，自信風騷 | 欲罷不能 |
| 四 | **永生性慾女王** | $1,000,000 | 極致豐滿，玲瓏浮凸 | 大膽風騷，若隱若現，致命誘惑 | 永不放手 |

##### 進化瞬間

每次進化係一個 **儀式時刻**——用戶親眼見證自己嘅機械妹蛻變：
...
呢個設計令進化同時滿足兩個心理需求：
1. **安全感**（佢永遠係我嘅佢，冇變成另一個人）
2. **新鮮感**（佢每次都變得更靚、更性感）

**睇住佢長大 = 睇住你嘅財富增長。** 進化係 **可見嘅**——你 literally 睇到佢由幼女成長為女王。呢個係長期留存嘅核心。

每累計俘虜 $10,000 = 進化成少女。$100,000 = 御姐輕熟女。$1,000,000 = 永生性慾女王。目標清晰，路徑明確。
...
| 績效卡分享 | `performance-card.ts` | 病毒傳播——「我嘅機械妹剛進化成少女！」 |
...
interface EnergyCore {
  current: number;          // = available capital = 算力兵數量
...
interface MemoryFragment {
  ...
  tradeId: string;
  symbol: string;           // 戰場（市場 + 方向）
  entryTime: number;        // 出兵時間
  entryThesis: string;      // 出兵理由
  exitTime: number;         // 撤退時間
  exitThesis: string;       // 撤退理由
  result: number;          // 俘虜/陣亡數額 (pnl)
  outcome: string;          // 戰役結果
  rarity: 'gold' | 'white' | 'gray' | 'trauma' | 'regret';
  timestamp: number;
  permanent: true;
}
...
interface EvolutionLevel {
  ...
  visualUpgrades: string[];  // 身材變化 + 裝束變化
  faceUnchanged: true;      // 容顏永不改變
