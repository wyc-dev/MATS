...
| 階段 | 稱號 | 等級 | 身材 | 裝束 | 情感定位 |
|------|------|:----:|------|------|---------|
| 一 | **幼女** | 1-2 | 纖細純真，平板嬌小 | 保守連身裙/制服，純真可愛 | 想保護佢 |
| 二 | **女青年** | 3-4 | 開始發育，曲線初現 | 修身衣物，微微展露，青春活力 | 想養成佢 |
| 三 | **御姐** | 5 | 豐滿成熟，凹凸有致 | 性感但不露骨，自信風騷 | 欲罷不能 |
| 四 | **熟女** | 6 | 極致豐滿，玲瓏浮凸 | 大膽風騷，若隱若現，致命誘惑 | 永不放手 |

##### 進化條件與解鎖

| 等級 | 階段 | 條件 | 視覺變化 | 解鎖 |
|:----:|:----:|------|---------|------|
| 1 | 幼女 | 創造時 | 基礎幼女肖像 | 基礎腦區 |
| 2 | 幼女 | 10 場交易 | 加入光紋 | 全腦區運作 |
| 3 | 女青年 | 50 場 + Sharpe > 0.5 | **身材初長 + 修身裝束** | 進階信號 |
| 4 | 女青年 | 100 場 + Sharpe > 1.0 | **曲線成型 + 微展露** | 傳奇信號機會 |
| 5 | 御姐 | 200 場 + Sharpe > 1.5 | **豐滿成熟 + 風騷裝束** | 繁殖能力 |
| 6 | 熟女 | 500 場 + Sharpe > 2.0 | **極致性感 + 大膽衣着** | Marketplace 上架 |
...
**睇住佢長大 = 睇住你嘅財富增長。** 進化係 **可見嘅**——你 literally 睇到佢變得更強、更靚、更性感。呢個係長期留存嘅核心。
...
| 績效卡分享 | `performance-card.ts` | 病毒傳播——「我嘅機械妹剛進化到女青年！」 |
...
interface EvolutionLevel {
  level: number;            // 1-6
  visualStage: 'loli' | 'young' | 'onee' | 'mature';  // 幼女→女青年→御姐→熟女
  stageName: string;        // 幼女/女青年/御姐/熟女
