...
NON-NEGOTIABLES: Never touch src/trading/*, src/config/*, .env. Never remove direction filtering, SL/TP validation, or safety checks. Never re-enable post-entry SL/TP narrowing (v2.0.225). Never use OLR P(win) for exit decisions (v2.0.225b).
```
