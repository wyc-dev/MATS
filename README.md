...
| **Testing** | vitest (609 core + 424 attack tests, gitignored; attack suites cover DCS, Q-RL, edge modules, creative vectors, ANN index, asset-aware Meta-Learner, audit→evolution routing) |
