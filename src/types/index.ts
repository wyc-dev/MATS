...
export interface TradeRecord {
  ...
  closeReason?: 'sl_tp' | 'tp_hit' | 'consensus' | 'consensus_reversal' | 'manual' | 'reconciliation' | 'exchange_closed' | 'thesis_invalidation' | 'exit_price_lock' | 'regime_reversal_lock' | 'reversal_point';
