...
export function savePortfolio(portfolio: Readonly<Portfolio>, trades?: readonly TradeRecord[], realTrades?: readonly TradeRecord[], realPositions?: readonly Position[]
  ...
  try {
    ...
    const positions = Array.from(portfolio.positions.values()).map(p => ({
      ...
      entryShadowWinRateSource: (p as any).entryShadowWinRateSource,
      entryConvictionLedger: (p as any).entryConvictionLedger,
    ...
    const serializedTrades = trades ? Array.from(trades).map(t => ({
      ...
      entryShadowWinRateSource: (t as any).entryShadowWinRateSource,
      entryConvictionLedger: (t as any).entryConvictionLedger,
